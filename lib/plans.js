...
const PHRASES = {
  en: {
    ...
    annualEq: (perMonth) => `or ${tk(perMonth)}/month billed annually`,
  },
  bn: {
    perMonth: "/মাস",
    ...
    annualEq: (perMonth) => `বার্ষিক বিলে মাসে ${tk(perMonth)}`,
  },
};
...
function toHomeCard(plan, i, total, popularIdx, lang) {
  ...
  return {
    ...
    yr: !isFree && monthly != null && yearly != null ? P.annualEq(yearly / 12) : null,
