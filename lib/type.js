...
const BN_TYPE = {
  ...
  h1: { fontFamily: BN, fontSize: 58, letterSpacing: "-1px", lineHeight: 1.15 },
  // Centred play-first headline — 62/-2.5/1.03 in EN.
  h1c: { fontFamily: BN, fontSize: 52, letterSpacing: "-0.5px", lineHeight: 1.16 },
  // Section headline — 44/-1.7/1.06 in EN.
  h2: { fontFamily: BN, fontSize: 37, letterSpacing: "-0.4px", lineHeight: 1.2 },
  // Section headline on a dark band — same metrics, kept separate so the two
  // can drift independently if the founder tunes one.
  h2b: { fontFamily: BN, fontSize: 37, letterSpacing: "-0.4px", lineHeight: 1.2 },
  // Closing CTA headline — 56/-2.3/1.03 in EN.
  ctaH2: { fontFamily: BN, fontSize: 47, letterSpacing: "-0.5px", lineHeight: 1.16 },
  // Card titles.
  h3: { fontFamily: BN, letterSpacing: "0", lineHeight: 1.35 },
