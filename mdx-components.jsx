...
export function useMDXComponents(components) {
  return {
    ...
    // Post bodies link both ways — SmartLink routes ours, leaves the rest alone.
    a: props => <SmartLink style={{ color: "#3E7A45", fontWeight: 600, textDecoration: "underline" }} {...props} />,
