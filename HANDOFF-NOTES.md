...
- **The Bangla is written, not translated.** Same argument, different words: where the English lands a pun the Bangla lands its own ("Not translated for it." → "অনুবাদ করা নয়।"). Deliberately left in English in both locales: product surface names (Nova, Nova HQ, Store Studio, Grow Labs, Front Office, Ads Gallery, Supplier Network), payment/courier brands, competitor names, and **every mono/all-caps label** — Bengali has no uppercase and shatters under the 0.08–0.14em tracking those carry. Numerals stay Western so prices match the app, invoices and the ad accounts.
